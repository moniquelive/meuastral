...
1. Build the Elm app: `npx elm-app build` (Cloudflare’s build step also calls this via `wrangler.toml`)
2. Preview locally (serving the build output through the worker runtime): `npx wrangler dev`
